...
//   let description = "You're Composting Efforts amounted to"
//   desc.innerHTML += description;
...
//     "max-w-full",
//   );
//   stat.innerHTML = statistic + " kg of CO2";
...
function TEST(
  ...
  var statCont1 = TEST1(stat1, desc1, icon1, icon1Sz);
  statCont1.classList.remove("md:w-3/12","w-4/5"); //,"w-4/5"
  statCont1.classList.add("mr-1","md:w-1/8", "w-1/3");
  var statCont2 = TEST1(stat2, desc2, icon2, icon2Sz);
  statCont2.classList.remove("md:w-3/12","w-4/5", "p-8");
  statCont2.classList.add("ml-1","md:w-1/8","max-w-full", "w-2/3", "py-4");
